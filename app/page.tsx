      ...
      <div className="relative z-10 space-y-12 sm:space-y-16">
        ...
        <section id="features" className="scroll-mt-36 space-y-10 font-sans">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
            ...
            <ScrollReveal variant="scale-up" delay={50} duration={800} className="md:col-span-2">
              <div className="group h-full p-7 sm:p-8 rounded-3xl border border-[#24231f] bg-[#161512] text-[#e5e5e0] font-sans shadow-md smooth-bento-card hover:bg-[#191814] flex flex-col justify-between space-y-6">
                <div>
            ...
            <ScrollReveal variant="scale-up" delay={180} duration={800} className="md:col-span-1">
              <div className="group h-full p-7 sm:p-8 rounded-3xl border border-[#24231f] bg-[#161512] text-[#e5e5e0] font-sans shadow-md smooth-bento-card hover:bg-[#191814] flex flex-col justify-between space-y-6">
                <div>
            ...
            <ScrollReveal variant="scale-up" delay={100} duration={800} className="md:col-span-1">
              <div className="group h-full p-7 sm:p-8 rounded-3xl border border-[#24231f] bg-[#161512] text-[#e5e5e0] font-sans shadow-md smooth-bento-card hover:bg-[#191814] flex flex-col justify-between space-y-6">
                <div>
                  <div className="p-2.5 w-fit rounded-xl bg-white/5 border border-white/10 text-white group-hover:scale-110 group-hover:bg-emerald-500/10 group-hover:text-emerald-400 transition-all duration-200 mb-4">
                    <Database size={22} />
            ...
            <ScrollReveal variant="scale-up" delay={220} duration={800} className="md:col-span-1">
              <div className="group h-full p-7 sm:p-8 rounded-3xl border border-[#24231f] bg-[#161512] text-[#e5e5e0] font-sans shadow-md smooth-bento-card hover:bg-[#191814] flex flex-col justify-between space-y-6">
                <div>
                  <div className="p-2.5 w-fit rounded-xl bg-white/5 border border-white/10 text-white group-hover:scale-110 group-hover:bg-emerald-500/10 group-hover:text-emerald-400 transition-all duration-200 mb-4">
                    <Cpu size={22} />
            ...
            <ScrollReveal variant="scale-up" delay={340} duration={800} className="md:col-span-1">
              <div className="group h-full p-7 sm:p-8 rounded-3xl border border-[#24231f] bg-[#161512] text-[#e5e5e0] font-sans shadow-md smooth-bento-card hover:bg-[#191814] flex flex-col justify-between space-y-6">
                <div>
                  <div className="p-2.5 w-fit rounded-xl bg-white/5 border border-white/10 text-white group-hover:scale-110 group-hover:bg-emerald-500/10 group-hover:text-emerald-400 transition-all duration-200 mb-4">
                    <ShieldCheck size={22} />
        ...
        <section className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center p-8 sm:p-12 rounded-3xl border border-[#24231f] bg-[#12110e] font-sans">
          <ScrollReveal variant="slide-left" duration={850} className="lg:col-span-6 space-y-4">
          ...
          {/* Code Snippet Box */}
          <ScrollReveal variant="slide-right" delay={150} duration={850} className="lg:col-span-6">
            <div className="rounded-2xl border border-[#24231f] bg-[#161512] p-6 space-y-3 font-sans text-xs shadow-md">
...
{`{
  ...
  "servers": [
    ...
    { "id": 102, "name": "AppServer-02", "watts": 385.2, "status": "spike" }
        ...
        {/* CTA Footer Banner */}
        <ScrollReveal variant="scale-up" duration={800} threshold={0.1}>
